...
public class BrowserFactory {
    ...
    //choose how you run tests : local or remotely
    private boolean isRemoteRun;

    //Constructor for class, which create value field (browserType, isRemoteRun)
    ...
    public WebDriver getBrowser() {
        //check - local or remotely
        if (isRemoteRun) {
            //create object desiredcapabilities, which we use to choose web browser
            DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
            //choose remotely webbrowser
            switch (browserType) {
                case CHROME:
                    //chromeoptions
    ...
    //method which return object remotewebdriver on base object desirecapabilities
